...
class TestDatabaseManager(unittest.TestCase):
    ...
    def test_update_and_get_relationship_data(self):
        ...
        self.db_manager.update_relationship_data(user_id, relationship_type, trust_level, rapport_level)
        relationship_data = self.db_manager.get_relationship_data(user_id, relationship_type)
