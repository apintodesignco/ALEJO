...
class TestGestureArpeggiator:
    ...
    def test_initialization(self, arpeggiator, mock_config_manager, mock_event_bus):
        ...
        assert arpeggiator.gesture_mappings[GestureType.SWIPE_LEFT] == "navigation.previous"
        assert arpeggiator.gesture_mappings[GestureType.SWIPE_RIGHT] == "navigation.next"
    ...
    def test_register_event_handlers(self, mock_event_bus):
        ...
        mock_event_bus.subscribe.assert_any_call("gesture.detected", arpeggiator._handle_gesture_detected)
        mock_event_bus.subscribe.assert_any_call("ui.mode_changed", arpeggiator._handle_ui_mode_changed)
        mock_event_bus.subscribe.assert_any_call("config.updated", arpeggiator._handle_config_updated)
    ...
    def test_update_configuration(self, arpeggiator, mock_config_manager):
        ...
        mock_config_manager.update_config.assert_called_once_with("gesture_arpeggiator", new_config)