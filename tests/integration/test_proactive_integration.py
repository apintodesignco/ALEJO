...
class TestProactiveIntegration(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_end_to_end_empathy_prompt(self):
        ...
        self.voice.voice_manager.voice_output.speak.assert_called_once_with(
            test_prompt
        )
    ...
    async def test_component_failure_handling(self):
        ...
        self.voice.voice_manager.voice_output.speak.side_effect = Exception("TTS failed")
    ...
    async def test_prompt_timing(self):
        ...
        await self.event_bus.subscribe(
            self.event_bus.EventType.PROACTIVE_PROMPT,
            ui_handler
        )
        await self.event_bus.subscribe(
            self.event_bus.EventType.PROACTIVE_PROMPT,
