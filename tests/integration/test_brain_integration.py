...
async def test_brain_registration():
    ...
    assert hasattr(brain, 'service_registry'), "ALEJOBrain should have a service_registry attribute after initialization"
    assert isinstance(brain.service_registry, ServiceRegistry), "service_registry should be an instance of ServiceRegistry"
