...
from alejo.core.self_healing import ComponentHealth, HealingStrategy, SelfHealingSystem
...
async def test_component_registration():
    ...
    system.register_component(
        "test_component", [HealingStrategy.RETRY, HealingStrategy.RESTART]
    )
...
async def test_multiple_recovery_strategies():
    ...
    system.register_component(
        "test_component",
        [HealingStrategy.RETRY, HealingStrategy.RESTART, HealingStrategy.DEGRADE],
    )
