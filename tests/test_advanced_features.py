...
async def test_transfer_learning(transfer_learning):
    ...
    transfer_learning.task_embeddings[source_task] = transfer_learning._compute_task_embedding({
        'complexity': 0.5,
        'description': 'test api function'
    })
    transfer_learning.task_embeddings[target_task] = transfer_learning._compute_task_embedding({
        'complexity': 0.6,
