...
try:
    ...
    from alejo.services.emotional_intelligence_service import app as emotional_app
...
class TestMicroservices(unittest.TestCase):
    ...
    def setUp(self):
        ...
        EmotionalProcessor().analyze_sentiment.return_value = {
            "valence": 0.5,
            "arousal": 0.5,
            "dominance": 0.5,
            "joy": 0.5,
        ...
        EmotionalMemory().get_relationship_context.return_value = {
            "trust_level": 0.5,
            "rapport_level": 0.5,
        }
        EthicalFramework().evaluate_action.return_value = MagicMock(
            value_alignment=0.8, justification="Ethical", principles_considered=[]
        )
        ...
        patcher_brain = patch(
            "alejo.services.brain_service.brain_instance", self.brain_service
        )
    ...
    def test_emotional_service_sentiment_analysis(self):
        ...
        self.emotional_service.analyze_sentiment = MagicMock(
    ...
    def test_emotional_service_empathetic_response(self):
        ...
        self.emotional_service.generate_empathetic_response = MagicMock(
    ...
    def test_emotional_service_ethical_evaluation(self):
        ...
        self.emotional_service.evaluate_ethical_action = MagicMock(
            return_value=mock_evaluation
        )

        response = self.emotional_client.post(
            "/ethical-evaluation", json={"action": action, "context": context}
        )
        self.assertEqual(response.status_code, 200)
