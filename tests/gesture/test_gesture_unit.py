...
from tests.gesture.test_config import TEST_ENV, get_mock_data_for_gesture, get_test_preset
...
class TestGestureProcessor(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.patcher = patch('alejo.interaction.gesture_arpeggiator.gesture_processor.mediapipe', self.mock_mediapipe)
        self.patcher.start()
    ...
    def test_process_frame_with_no_hands(self):
        ...
        self.mock_mediapipe.solutions.hands.Hands().process().multi_hand_landmarks = None
    ...
    def test_process_frame_with_hands(self):
        ...
        self.mock_mediapipe.solutions.hands.Hands().process().multi_hand_landmarks = [mock_landmarks]
