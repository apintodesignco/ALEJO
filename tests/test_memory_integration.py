...
class TestMemorySystemIntegration:
    ...
    async def test_01_working_to_episodic_memory_flow(
        self, working_memory, episodic_memory, event_bus
    ):
    ...
    async def test_02_episodic_to_semantic_memory_flow(
        self, episodic_memory, semantic_memory, event_bus
    ):
    ...
    async def test_03_semantic_to_working_memory_flow(
        self, working_memory, semantic_memory, event_bus
    ):
        """Test that semantic knowledge influences working memory focus."""
        # Create semantic concepts
        sky_concept = Concept(
            name="sky", attributes={"color": "blue", "location": "above"}
        )
        blue_concept = Concept(
            name="blue", attributes={"type": "color", "wavelength": "440-490nm"}
        )
    ...
    async def test_04_concurrent_memory_operations(
        self, working_memory, episodic_memory, semantic_memory, event_bus
    ):
    ...
    async def test_05_memory_error_handling(
        self, working_memory, episodic_memory, semantic_memory, event_bus
    ):
    ...
    async def test_06_memory_cleanup_and_decay(
        self, working_memory, episodic_memory, event_bus
    ):
